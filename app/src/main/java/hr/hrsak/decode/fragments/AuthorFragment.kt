...
class AuthorFragment(val repoItem: RepoItem) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvAuthorHtml.text = repoItem.owner.htmlUrl

        setClickListener()
    }

    private fun setClickListener() {
        tvAuthorHtml.setOnClickListener{
            val webIntent: Intent = Uri.parse(repoItem.owner.htmlUrl).let { webpage ->
